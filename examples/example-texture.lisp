...
(v:define-texture 1d-gradient
    (:texture-1d virality.textures:clamp-all-edges)
  (:data #((:example-texture "texture-gradient-1d.tiff"))))

(v:define-texture 2d-wood
    (:texture-2d virality.textures:clamp-all-edges)
  (:data #((:example-texture "wood.tiff"))))

(v:define-texture 3d
    (:texture-3d virality.textures:clamp-all-edges)
...
(v:define-texture 1d-array
    (:texture-1d-array virality.textures:clamp-all-edges)
...
(v:define-texture 2d-array
    (:texture-2d-array virality.textures:clamp-all-edges)
...
(v:define-material 1d-gradient
    (:shader virality.shader.user:unlit-texture-1d
...
(v:define-material 3d
  (:shader virality.shader.user:unlit-texture-3d
   :profiles (virality.materials:u-mvp)
   :uniforms
   ((:tex.sampler1 '3d)
    (:mix-color (v4:one))
...
(v:define-material 1d-array
  (:shader virality.shader.user:unlit-texture-1d-array
...
(v:define-material 2d-array
  (:shader virality.shader.user:unlit-texture-2d-array
   :profiles (virality.materials:u-mvpt)
   :uniforms
...
(v:define-material 2d-sweep-input
  (:shader virality.shader.user:noise-2d/sweep-input
   :profiles (virality.materials:u-mvp)
   :uniforms
...
(v:define-material cubemap
  (:shader virality.shader.user:unlit-texture-cube-map
   :profiles (virality.materials:u-mvp)
   :uniforms
...
(v:define-material cubemaparray
  (:shader virality.shader.user:unlit-texture-cube-map-array
   :profiles (virality.materials:u-mvp)
   :uniforms
...
(defmethod v:on-component-initialize ((self shader-sweep))
  (with-slots (%renderer) self
    (setf %renderer (v:component-by-type (v:actor self) 'render))))
...
(defmethod v:on-component-update ((self shader-sweep))
  (with-slots (%material %material-retrieved-p) self
    (unless %material-retrieved-p
      (setf %material (v/comp:material (renderer self))
...
(virality.prefab:define-prefab "texture" (:library examples :policy :new-type)
  (("camera" :copy "/cameras/perspective")
   (v/comp:camera (:policy :new-args) :zoom 6))
  (("1d-texture" :copy "/mesh")
   (v/comp:transform :translate (v3:vec -4 3 0))
   (v/comp:render :material '1d-gradient))
  (("2d-texture" :copy "/mesh")
   (v/comp:transform :translate (v3:vec -2 3 0))
   (v/comp:render :material '2d-wood))
  (("3d-texture" :copy "/mesh")
   (v/comp:transform :translate (v3:vec 0 3 0))
   (v/comp:render :material '3d))
  (("1d-array-texture" :copy "/mesh")
   (v/comp:transform :translate (v3:vec 2 3 0))
   (v/comp:render :material '1d-array))
  (("2d-array-texture" :copy "/mesh")
   (v/comp:transform :translate (v3:vec 4 3 0))
   (v/comp:render :material '2d-array))
  (("swept-input" :copy "/mesh")
   (v/comp:transform :translate (v3:vec -4 1 0))
   (v/comp:render :material '2d-sweep-input)
   (shader-sweep))
  (("cube-map" :copy "/mesh")
   ...
   (v/comp:render :material 'cubemap))
  (("cube-map-array" :copy "/mesh")
   (v/comp:transform :translate (v3:vec 3 -1 0)
                     :rotate/inc (q:orient :world (v3:one) (/ pi 4)))
   (v/comp:static-mesh :location '((:core :mesh) "cube.glb"))
   (v/comp:render :material 'cubemaparray)))

;;; Prefab descriptors

(virality.prefab:define-prefab-descriptor texture ()
  ("texture" virality.examples:examples))
