...
(v:define-material damaged-helmet
  (:shader virality.shader.user:damaged-helmet
...
(virality.prefab:define-prefab "damaged-helmet" (:library examples)
  (("camera" :copy "/cameras/perspective")
   (v/comp:camera (:policy :new-args) :zoom 10))
  (("helmet" :copy "/mesh")
   (v/comp:transform :rotate (q:orient :local :x (/ pi 2))
...
(virality.prefab:define-prefab-descriptor damaged-helmet ()
  ("damaged-helmet" virality.examples:examples))
