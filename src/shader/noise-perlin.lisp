...
(define-function perlin ((point :vec2))
  (perlin point (lambda ((x :vec2)) (virality.shader.hash:fast32/2-per-corner x))))
...
(define-function perlin/derivs ((point :vec2)
  ...
  (mvlet* ((cell (floor point))
           ...
           (blend (virality.shader.shaping:quintic-curve/interpolate-derivative
                   (.xy vecs)))
           (out (+ dotval0-grad0
                   (* (.x blend) k0-gk0)
...
(define-function perlin-surflet ((point :vec2)
  ...
  (mvlet* ((cell (floor point))
           ...
           (out (dot (virality.shader.shaping:falloff-squared-c2
...
(define-function perlin-improved ((point :vec2))
  (perlin-improved point (lambda ((x :vec2)) (virality.shader.hash:fast32 x))))
...
(define-function perlin ((point :vec3))
  (perlin point (lambda ((x :vec3)) (virality.shader.hash:fast32/3-per-corner x))))
...
(define-function perlin/derivs ((point :vec3)
  ...
  (mvlet* ((cell (floor point))
           ...
           (k6-gk6 (- (- dot7-grad7 dot6-grad6) (- dot5-grad5 dot4-grad4)
                      k3-gk3))
           (blend (virality.shader.shaping:quintic-curve vec))
           (blend-deriv (virality.shader.shaping:quintic-curve/derivative vec))
           (out (+ dot0-grad0
...
(define-function perlin-surflet ((point :vec3)
  ...
  (mvlet* ((cell (floor point))
           ...
           (out (* (+ (dot (virality.shader.shaping:falloff-squared-c2
                           ...
                           temp1)
                      (dot (virality.shader.shaping:falloff-squared-c2
...
(define-function perlin-improved ((point :vec3))
  (perlin-improved point (lambda ((x :vec3)) (virality.shader.hash:fast32 x))))
...
(define-function perlin ((point :vec4))
  (perlin point (lambda ((x :vec4)) (virality.shader.hash:fast32-2/4-per-corner x))))
